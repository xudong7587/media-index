...
| Generic incremental webhook | `api/mdc_webhook.py`, `scheduler` | `features/integrations` | token authenticated; request body cannot widen saved scope; completion events coalesce into incremental jobs |
