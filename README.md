...
![Version](https://img.shields.io/badge/version-0.6.12-6d7cff?style=flat-square)
...
- **通知与交互**：企业微信自建应用、企微机器人和 Telegram；媒体通知优先使用海报图文卡片与易读字段，同一媒体的一次多集或多网盘操作只通知一次，并提供 STRM、订阅管理和服务器信息快捷菜单，可通过编号选择 STRM 来源根目录的一级子目录执行指定扫描。
