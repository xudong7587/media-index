...
![Version](https://img.shields.io/badge/version-0.4.7-6d7cff?style=flat-square)
...
- 按 TMDB 日期运行的愿望单
- 右上角小铃铛通知中心，以及 Telegram、企业微信群机器人和企业微信自建应用推送
- 企业微信自建应用双向交互：手机发送资源名、编号确认和待确认任务处理
...
通知配置位于 **设置 → 通知设置**。网页内通知统一显示在右上角小铃铛中，不再提供单独的顶级通知页面。外部消息可按需启用以下渠道：
